export const gentleExercises = [
  {
    id: "e1",
    name: "Morning Walking",
    lugandaName: "Okutambula ku Makya",
    description:
  ...
  },
  {
    ...
    instructions: [
      ...
      "Lift arms up and down slowly (10 repetitions)",
  ...
  },
  {
    ...
    precautions:
      "If you feel dizzy, return to normal breathing. Practice regularly for best results.",
  },
  {
    id: "e4",
    name: "Gentle Stretching",
    lugandaName: "Okugolola Omubiri Mpola",
    description:
    ...
    instructions: [
      ...
      "Gentle torso twists while seated",
      "Ankle circles - lift feet and rotate ankles",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Move feet up and down in water",
      "Make circles with feet in water",
      "Flex and point toes repeatedly",
      "Splash gently with hands for arm movement",
    ],
    lugandaInstructions: [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Practice gentle head and neck movements",
      "Do 5 minutes of deep breathing",
      "Gentle self-massage of temples and shoulders",
      "End with gratitude thoughts for the day",
    ],
    lugandaInstructions: [
